...
import org.springrain.nybusiness.eme.service.ITsEmergencyEquipmentSumService;
 ...
 * @see org.springrain.nybusiness.eme.web.TsEmergencyEquipmentSum
 */
@Controller
...
public class TsEmergencyEquipmentSumController  extends BaseController {
	...
	private String listurl="/nybusiness/eme/tsemergencyequipmentsum/tsemergencyequipmentsumList";
	...
	public String look(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception {
		...
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/nybusiness/eme/tsemergencyequipmentsum/tsemergencyequipmentsumLook";
	}
	...
	public String updatepre(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception{
		ReturnDatas returnObject = lookjson(model, request, response);
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/nybusiness/eme/tsemergencyequipmentsum/tsemergencyequipmentsumCru";
	}
