...
import org.springrain.nybusiness.eme.service.ITsEmeEquSumCategoryService;
 ...
 * @see org.springrain.nybusiness.eme.web.TsEmeEquSumCategory
 */
@Controller
...
public class TsEmeEquSumCategoryController  extends BaseController {
	...
	private String listurl="/nybusiness/eme/tsemeequsumcategory/tsemeequsumcategoryList";
	...
	public String look(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception {
		...
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/nybusiness/eme/tsemeequsumcategory/tsemeequsumcategoryLook";
	}
	...
	public String updatepre(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception{
		ReturnDatas returnObject = lookjson(model, request, response);
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/nybusiness/eme/tsemeequsumcategory/tsemeequsumcategoryCru";
	}
