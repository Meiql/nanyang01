...
import org.springrain.nybusiness.eme.service.ITsEmePlanFilingModService;
 ...
 * @see org.springrain.nybusiness.eme.web.TsEmePlanFilingMod
 */
@Controller
...
public class TsEmePlanFilingModController  extends BaseController {
	...
	private String listurl="/nybusiness/eme/tsemeplanfilingmod/tsemeplanfilingmodList";
	...
	public String look(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception {
		...
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/nybusiness/eme/tsemeplanfilingmod/tsemeplanfilingmodLook";
	}
	...
	public String updatepre(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception{
		ReturnDatas returnObject = lookjson(model, request, response);
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/nybusiness/eme/tsemeplanfilingmod/tsemeplanfilingmodCru";
	}
