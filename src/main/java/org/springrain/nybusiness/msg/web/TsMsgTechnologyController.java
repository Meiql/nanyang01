 ...
 */
@Controller
@RequestMapping(value="/tsmsgtechnology")
public class TsMsgTechnologyController  extends BaseController {
	@Resource
	private ITsMsgTechnologyService tsMsgTechnologyService;
	
	private String listurl="/nybusiness/msg/tsmsgtechnology/tsmsgtechnologyList";
